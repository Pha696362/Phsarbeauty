...
interface Props {
    ...
    export default ({onClose,onShare,saveData,onSave, onUnSave,onModal,adsDoc,loading, onPress, comady, loadingMore, loadingRefresh, onEndReached, onStartReached, onMore, onRefesh }: Props) => {
    const dataContent: any = addAdsInArray(comady, adsDoc, 5);
