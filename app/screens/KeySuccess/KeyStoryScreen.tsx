...
interface Props {
    ...
    export default ({onClose, onShare,saveData,onSave, onUnSave,onModal,adsDoc,loading, onPress, keystory, loadingMore, loadingRefresh, onEndReached, onStartReached, onMore, onRefesh }: Props) => {
    const dataContent: any = addAdsInArray(keystory, adsDoc, 5);
