...
interface Props {
    ...
    export default ({onClose,onShare,saveData,onSave, onUnSave,onModal,adsDoc,loading, onPress, love, loadingMore, loadingRefresh, onEndReached, onStartReached, onMore, onRefesh }: Props) => {
    const dataContent: any = addAdsInArray(love, adsDoc, 5);
