...
interface Props {
    ...
    export default ({onClose,onShare,saveData,onSave, onUnSave,onModal,adsDoc,loading, onPress, beauty, loadingMore, loadingRefresh, onEndReached, onStartReached, onMore, onRefesh }: Props) => {
    const dataContent: any = addAdsInArray(beauty, adsDoc, 5);
